Generate and install the app icon for /tmp/astracommerce-canvas.
...
/tmp/astracommerce-canvas/app/src/main/res/drawable/icon.png
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/astracommerce-canvas/app/src/main/res/drawable/icon.png`.
