...
import astracommercetrade.art.astracanvas.di.dataModule
import astracommercetrade.art.astracanvas.di.dispatcherModule
import astracommercetrade.art.astracanvas.di.viewModule
...
class JVONGApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@JVONGApplication)
            modules(appModules)
        }
